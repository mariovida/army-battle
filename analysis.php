...
<html>
  <head>
    ...
    <title>ARMY BATTLE - ANALYSIS</title>
  </head>
  <body>
    <a href="index.php" class="switch">HOME PAGE</a>
      ...
      <?php
        if(isset($_GET['submit'])) {
          ...
          while (($army1->numSoldiers > 0) && ($army2->numSoldiers > 0)) {
            ...
            if($defender == $army1 && $defender->health <= 0) {
              echo "<br>Red Army soldier health is now: 0";
            } else if ($defender == $army1) {
          	  echo "<br>Red Army soldier health is now: " . $defender->health;
            } else if ($defender == $army2 && $defender->health <= 0) {
              echo "<br>Blue Army soldier health is now: 0";
            } else {
              echo "<br>Blue Army soldier health is now: " . $defender->health;
            }
